...
- `samwoo/upstream-v1.4.168`의 `v1.4.197` 릴리스 후보에 text file bridge와 분리된 document protocol을 통합했다. native picker의 PDF/XLSX/PPTX/이미지는 main-owned artifact ID로만 전달한다.
