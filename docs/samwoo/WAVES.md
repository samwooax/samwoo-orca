...
| W6a | 프로필 멤버 디렉터리·메신저 실명 표시 | login 원인 수정·v1.4.186/VPS 반영 대기 | f4d4df553, 0262f692d |
| W6b | 허브 2단계 — 담당자·마감일·작업 항목 | login 원인 수정·v1.4.186/VPS 반영 대기 | 30e8ef9b8, 086c4a4fd, 0262f692d |
...
| W11 | 로그인 식별자 정규화·릴리스 UI 정리 | 구현 완료·v1.4.186 빌드 대기 | 0262f692d, 이번 커밋 |
...
- 남은 단계: `v1.4.186` Windows 빌드·공개, VPS 서버 모듈 재배포·재시작, 앱 재로그인 뒤 2계정 GUI 실측.
