...
| W6a | 프로필 멤버 디렉터리·메신저 실명 표시 | v1.4.186·VPS 반영 완료, GUI 실측 대기 | f4d4df553, 0262f692d, run 31318757576 |
| W6b | 허브 2단계 — 담당자·마감일·작업 항목 | v1.4.186·VPS 반영 완료, GUI 실측 대기 | 30e8ef9b8, 086c4a4fd, 0262f692d, run 31318757576 |
