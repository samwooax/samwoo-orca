...
| W15     | Hermes PDF/XLSX/PPTX 로컬 문서 도구                          | v1.4.196 draft 검증 완료·설치본 GUI 재실측 대기                   | b730f5494, b12d4ede7, b6ce7fd75, run 31868556602                       |
...
- 남은 단계: v1.4.196 설치본에서 PDF/XLSX/PPTX의 Explorer 선택·첨부 버튼·native save GUI를 재실측한 뒤 공개한다.
