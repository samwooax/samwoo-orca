...
export function openDetectedFilePath(
  ...
  void (async () => {
    ...
    if (openWithSystemDefault && canOpenWithSystemDefault) {
      // Why: Shift+Cmd/Ctrl mirrors URL links by escaping SAMWOO-ORCA and honoring the
    ...
    // Why: local HTML files render in SAMWOO-ORCA's browser for ordinary Cmd/Ctrl-click,
