...
export function handleOscLink(
  ...
  // Why: xterm renders OSC 8 links as clickable anchors. SAMWOO-ORCA must suppress
  ...
  if (parsed.protocol === 'file:') {
    // Why: file:// URIs should open inside SAMWOO-ORCA, not via the OS default editor
