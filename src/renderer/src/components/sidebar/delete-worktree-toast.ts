...
export function getDeleteWorktreeToastCopy(
  ...
  if (forceDeleteReason) {
    ...
    if (forceDeleteReason === 'missing-registration') {
      return {
        ...
        description: translate(
          ...
          'Git already removed this workspace. Use Force Delete to clear it from SAMWOO-ORCA.'
        ),
        isDestructive: false
      }
    }
    return {
      ...
      // made a normal cleanup step look like an SAMWOO-ORCA bug, so this common case
