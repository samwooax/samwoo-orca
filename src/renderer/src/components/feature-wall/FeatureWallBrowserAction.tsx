...
// needs the SAMWOO-ORCA CLI and browser skill, not Computer Use or orchestration.
...
// The grab→agent flow relies on the SAMWOO-ORCA CLI and browser skill, so offer the same
// install action the Enable SAMWOO-ORCA CLI step uses, scoped to just browser use.
