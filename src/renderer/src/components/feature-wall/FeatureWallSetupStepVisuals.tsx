...
// Mac-style terminal traffic-light dots — the signature of an SAMWOO-ORCA terminal pane.
...
// Use SAMWOO-ORCA's browser: a browser pane with a cursor grabbing one highlighted
