...
// Why: this animation tells the full SAMWOO-ORCA story end-to-end — the user opens a
...
// SAMWOO-ORCA's dropdown/popover primitives while staying inside the storyboard DOM.
