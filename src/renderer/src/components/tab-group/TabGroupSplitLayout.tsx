  ...
  return (
    ...
    >
      <DndContext
        ...
        autoScroll={false}
      >
        {/* Why: the tab row itself is 36px so its visible surface matches the
          sibling `titlebar-left`; a separate 4px band made the tab box appear
          shorter even though both columns ended at the same baseline.
