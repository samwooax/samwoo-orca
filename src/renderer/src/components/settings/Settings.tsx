...
function Settings(): React.JSX.Element {
  ...
  // Why: General owns the SAMWOO-ORCA CLI controls, including WSL skill-location setup.
              ...
              <ActiveSettingsSectionProvider value={activeSectionId}>
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Optional. SAMWOO-ORCA works with your existing provider logins; add accounts only if you want SAMWOO-ORCA to help switch between them.'
                  )}
                  badge={translate(
