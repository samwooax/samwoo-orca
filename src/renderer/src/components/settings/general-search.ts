...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'SAMWOO-ORCA CLI'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the SAMWOO-ORCA CLI command.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the SAMWOO-ORCA skill so agents know to use the SAMWOO-ORCA CLI.'
    ),
    keywords: [
