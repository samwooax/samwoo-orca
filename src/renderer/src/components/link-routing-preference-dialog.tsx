                ...
                <DialogTitle className="text-xl leading-tight">
                  {openLinksInAppDefault
                    ? translate(
                        ...
                        "Keep terminal links in SAMWOO-ORCA's browser?"
                      )
                    : translate(
                        'auto.components.link.routing.preference.dialog.title',
                        "Open terminal links in SAMWOO-ORCA's browser?"
                      )}
                </DialogTitle>
                <DialogDescription className="text-sm leading-relaxed">
                  {openLinksInAppDefault
                    ...
                    : translate(
                        ...
                        "Use SAMWOO-ORCA's browser for terminal links, or keep your system browser."
                      )}
                </DialogDescription>
              </div>
            </DialogHeader>
              ...
              <div className="space-y-1">
                <p>
                  {translate(
                    ...
                    'SAMWOO-ORCA can use imported cookies for logged-in sites.'
                  )}
                </p>
                <p>
                  {translate(
                ...
                <p className="flex flex-wrap items-center gap-x-1.5 gap-y-1">
                  <span>
                    {translate(
                      ...
                      'When links open in SAMWOO-ORCA,'
                    )}
                  </span>
                  <ShortcutKeyCombo
