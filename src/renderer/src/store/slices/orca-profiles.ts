...
export const createOrcaProfilesSlice: StateCreator<AppState, [], [], OrcaProfilesSlice> = (
  ...
  fetchOrcaProfiles: async () => {
    ...
    try {
      ...
      console.error('Failed to fetch SAMWOO-ORCA profiles:', err)
  ...
  fetchOrcaProfileAuthStatus: async () => {
    try {
      ...
      console.error('Failed to fetch SAMWOO-ORCA profile auth status:', err)
      return null
    }
  },
  ...
  createLocalOrcaProfile: async (name) => {
    try {
      ...
      console.error('Failed to create SAMWOO-ORCA profile:', err)
      toast.error(
  ...
  switchOrcaProfile: async (profileId) => {
    ...
    try {
      ...
      console.error('Failed to switch SAMWOO-ORCA profile:', err)
      set({ orcaProfileSwitching: false })
      toast.error(
  ...
  transferOrcaProfileProject: async (args) => {
    try {
      ...
      console.error('Failed to transfer SAMWOO-ORCA profile project:', err)
      toast.error(
