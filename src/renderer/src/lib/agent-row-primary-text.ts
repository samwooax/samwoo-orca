...
/** True when the live prompt is still an SAMWOO-ORCA dispatch turn (not sticky metadata alone). */
...
export function getAgentRowPrimaryText(
  ...
  // first characters are boilerplate ("You are working inside SAMWOO-ORCA…").
