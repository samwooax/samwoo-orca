 ...
 * PTY. TerminalTab.launchAgent records the harness SAMWOO-ORCA started; manually typed
...
function deriveTitleHintAgentTarget(
  ...
  if (!titleEvidence) {
    // Why: launchAgent is set the instant SAMWOO-ORCA spawns the tab, but the runtime
