...
export const getAgentCatalog = createLocalizedCatalog((): AgentCatalogEntry[] => [
  ...
  },
  {
    ...
    cmd: 'openclaude',
    // Why: OpenClaude's published favicon has a padded 500px canvas; SAMWOO-ORCA
  ...
  },
  {
    ...
    // the settings pane's "default command" hint aligns with what SAMWOO-ORCA
  ...
  },
  {
    ...
    // suggestion that SAMWOO-ORCA is looking for Windows' built-in `cmd.exe`.
    cmd: 'command-code',
