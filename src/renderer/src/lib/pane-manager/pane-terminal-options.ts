...
export function buildDefaultTerminalOptions(): ITerminalOptions {
  ...
  return {
    ...
    // Why: SAMWOO-ORCA's default terminal cells are taller than many users' baseline
    ...
    // (CSI ? u) know SAMWOO-ORCA accepts enhanced key reporting. SAMWOO-ORCA still writes
