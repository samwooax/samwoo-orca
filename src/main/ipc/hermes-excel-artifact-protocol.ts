...
cells는 address와 value 또는 formula를 사용합니다. formats 예: {"id":"title","font":{"name":"맑은 고딕","size":18,"bold":true,"color":"#FFFFFF"},"fill":{"color":"#1D4ED8"},"alignment":{"horizontal":"center","vertical":"center","wrapText":true},"border":{"style":"thin","color":"#CCCCCC"},"numberFormat":"#,##0"} — fill은 색 문자열이 아니라 {"color":"#RRGGBB"} 객체이며 셀은 formatId로 참조합니다.
conditionalFormats는 값 비교 규칙 {"range":"D2:D6","type":"cell","operator":"greaterThanOrEqual","value":0,"formatId":"positive"} 또는 수식 규칙 {"range":"D2:D6","type":"formula","formula":"=$D2<0","formatId":"negative"}만 사용하세요. type은 cellIs가 아니라 cell이며 비교 대상 숫자는 formula가 아니라 value에 넣습니다.
