...
freezePane은 셀 주소가 아니라 {"row":3,"column":0}처럼 고정할 행·열 개수이고, merges는 ["A1:D1"] 같은 범위 배열입니다. 표(tables)의 헤더 행 열 이름은 표 안에서 서로 달라야 하며(같은 이름 두 번 금지), 표 이름은 셀 주소처럼 보이면 안 됩니다. 첨부 이미지는 images 항목의 artifactPath에 @attachments/... 경로를 사용합니다.
