...
import { registerSamwooScheduleResultHandlers } from './samwoo-schedule-results'
...
export function registerCoreHandlers(
  ...
  registerSamwooScheduleResultHandlers(store)
  ...
  registerMessengerPopoutHandlers(store)
