...
const ATOM_FEED_URL = 'https://github.com/dhun827/samwoo-orca/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/dhun827/samwoo-orca/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/dhun827\/samwoo-orca\/releases\/tag\/([^"]+)"/g
